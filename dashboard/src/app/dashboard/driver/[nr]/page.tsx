	...
	return (
		<div className="flex h-full flex-col">
			...
			<div style={{
				...
				<div style={{ position: "relative", zIndex: 1 }}>
					...
					<div style={{ lineHeight: 0.92 }}>
						<span style={{ fontSize: "clamp(28px,5vw,56px)", fontWeight: 900, letterSpacing: "-.04em", color: "var(--f1-text)" }}>Driver </span>
						<span style={{
			...
			<div className="flex flex-1 flex-col items-center justify-center gap-3">
				...
				<p style={{ fontSize: 18, fontWeight: 700, color: "var(--f1-text)" }}>Coming Soon</p>
				<p style={{ fontSize: 13, color: "var(--f1-muted)" }}>Detailed driver stats and telemetry — in development.</p>
			</div>
		</div>
	);
}
