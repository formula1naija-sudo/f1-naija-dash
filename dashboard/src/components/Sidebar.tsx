...
export default function Sidebar({ connected }: Props) {
	...
	return (
		<div>
          ...
          <Item target="_blank" item={{ href: "/news", name: "News" }} />
					...
					<div className="flex flex-col gap-1">
						<Item target="_blank" item={{ href: "https://x.com/f1_naija", name: "X (Twitter)" }} />
						<Item target="_blank" item={{ href: "https://www.instagram.com/f1_naija/", name: "Instagram" }} />
						<Item target="_blank" item={{ href: "https://www.tiktok.com/@f1.naija", name: "TikTok" }} />
					</div>
				</nav>
			</motion.div>
		</div>
