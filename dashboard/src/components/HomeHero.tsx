          ...
          <div className="hero-glow-wrap w-full" style={{ maxWidth: 370 }}>
            <div style={{ borderRadius: 14, background: "#0d1424", overflow: "hidden", position: "relative" }}>
              ...
              <div style={{
                ...
                padding: "13px 18px", background: "rgba(0,0,0,.3)",
              ...
              {MOCK_DRIVERS.map((d, i) => (
                <div key={d.pos} style={{
                  ...
                  padding: "10px 18px",
                  borderBottom: i < MOCK_DRIVERS.length - 1 ? "1px solid rgba(255,255,255,.04)" : "none",
                }}>
                  <div style={{
                    width: 20, fontSize: 12, fontWeight: 700, textAlign: "center", flexShrink: 0,
                    color: d.pos === 1 ? "#f5a724" : d.pos === 2 ? "#c0c8d8" : d.pos === 3 ? "#cd7f32" : "#5a6888",
                  }}>{d.pos}</div>
                  ...
                  <div style={{
                    fontSize: d.pos === 1 ? 10 : 11,
                    fontWeight: d.pos === 1 ? 800 : 600,
                    color: d.pos === 1 ? "#f5a724" : "#5a6888",
                    textAlign: "right", minWidth: 52,
                    textTransform: d.pos === 1 ? "uppercase" : "none",
                    letterSpacing: d.pos === 1 ? ".05em" : "normal",
                  }}>
              ...
              {/* footer */}
              <div style={{
                padding: "12px 18px", background: "rgba(0,0,0,.2)",
                display: "flex", alignItems: "center", justifyContent: "space-between",
              }}>
                <div>
